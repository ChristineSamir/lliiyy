...
def Read_Train_Images_in_folder():
    imagePath = glob.glob('E:\\Automatic Colorization\\DataSet 400x400\\*.jpg') 
...
def ReadLabels_Train_Images_in_folder():
    imagePath = glob.glob('E:\\Automatic Colorization\\DataSet 388x388\\*.jpg') 
...
def Read_GreyTest_Images_in_folder():
    imagePath = glob.glob('E:\\Automatic Colorization\\Test\\*.jpg')
...
def TrainCnn():
    ...
    with tf.Session() as sess:
        sess.run(init_op)
        #saver.restore(sess, "E:/Automatic Colorization/WeightsModel/model/model.ckpt")
        for epoch in range(15000):
            ...
            for i in range(int(6208/20)):
                ...
                epoch_loss +=c
                save_path = saver.save(sess, "E:/Automatic Colorization/WeightsModel/model/model.ckpt")
...
def testNN():
    ...
    with tf.Session() as sess:
        init_op = tf.global_variables_initializer()
        sess.run(init_op)
        saver.restore(sess, "E:/Automatic Colorization/WeightsModel/model/model/model.ckpt") 
        ...
        for i in range (2086):
          ...
          cv2.imwrite('E:/Automatic Colorization/WeightsModel/Results/res.jpg',Result);
          cv2.imwrite('E:/Automatic Colorization/WeightsModel/Results/input.jpg',Image.reshape([-1,GreyResizeWidth,GreyResizeHeight])[0])
          img = cv2.imread("E:/Automatic Colorization/WeightsModel/Results/res.jpg")
